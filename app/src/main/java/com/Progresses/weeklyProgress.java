...
public class weeklyProgress extends Fragment implements View.OnClickListener{
    LineChart linech;
    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view =inflater.inflate(R.layout.weekly,container,false);
        linech = (LineChart) view.findViewById(R.id.weeklyGraph);

        LineDataSet set=new LineDataSet(data(),"weekly");
