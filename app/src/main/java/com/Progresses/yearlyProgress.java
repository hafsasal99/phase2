...
public class yearlyProgress extends Fragment implements View.OnClickListener{
    LineChart linech;
    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view =inflater.inflate(R.layout.yearly,container,false);
        linech = (LineChart) view.findViewById(R.id.yearlyGraph);

        LineDataSet set=new LineDataSet(data(),"yearly");
